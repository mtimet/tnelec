...
CIRCONSCRIPTIONS = {"111":{"name":"Tunis 1","shp":"tunis1","delegations":{"52":{"name":"Médina"},"53":{"name":"Bab Bhar"},"54":{"name":"Bab Souika"},"61":{"name":"Sijoumi"},"62":{"name":"Ezzouhour"},"63":{"name":"Hrairia"},"64":{"name":"Sidi Hassine"},"65":{"name":"El Ouardia"},"66":{"name":"Kabaria"},"67":{"name":"Sidi El Béchir"},"68":{"name":"Jebel Jelloud"}}},"112":{"name":"Tunis 2","shp":"tunis2","delegations":{"51":{"name":"Carthage"},"55":{"name":"Omrane"},"56":{"name":"Omrane Supérieur"},"57":{"name":"El Tahrir"},"58":{"name":"El Menzah"},"59":{"name":"Cité El Khadra"},"60":{"name":"Bardo"},"69":{"name":"La Goulette"},"70":{"name":"Kram"},"71":{"name":"La Marsa"}}},"120":{"name":"Ariana","shp":"ariana","delegations":{"51":{"name":"Ariana Médina"},"52":{"name":"Soukra"},"53":{"name":"Raoued"},"54":{"name":"Kalaat El Andalous"},"55":{"name":"Sidi Thabet"},"56":{"name":"Ettadhamen"},"57":{"name":"Mnihla"}}},"130":{"name":"Ben Arous","shp":"benarous","delegations":{"51":{"name":"Ben Arous"},"52":{"name":"Nouvelle Médina"},"53":{"name":"El Mourouj"},"54":{"name":"Hammam Lif"},"55":{"name":"Hammam Chott"},"56":{"name":"Boumhel"},"57":{"name":"Ezzahra"},"58":{"name":"Radès"},"59":{"name":"Mégrine"},"60":{"name":"M'Hamdia"},"61":{"name":"Fouchana"},"62":{"name":"Mornag"}}},"140":{"name":"Manubah","shp":"manubah","delegations":{"51":{"name":"Manouba"},"52":{"name":"Douar Hicher"},"53":{"name":"Oued Ellil"},"54":{"name":"Mornaguia"},"55":{"name":"Borj El Amri"},"56":{"name":"Jedaida"},"57":{"name":"Tebourba"},"58":{"name":"El Battan"}}},"151":{"name":"Nabel 1","shp":"nabeul1","delegations":{"51":{"name":"Nabeul"},"52":{"name":"Dar Chaabane El Fehri"},"53":{"name":"Beni Khiar"},"54":{"name":"Korba"},"55":{"name":"Menzel Temime"},"56":{"name":"El Mida"},"57":{"name":"Kelibia"},"58":{"name":"Hammam Ghezaz"},"59":{"name":"Haouaria"}}},"152":{"name":"Nabel 2","shp":"nabeul2","delegations":{"60":{"name":"Takelsa"},"61":{"name":"Soliman"},"62":{"name":"Menzel Bouzelfa"},"63":{"name":"Beni Khalled"},"64":{"name":"Grombalia"},"65":{"name":"Bou Argoub"},"66":{"name":"Hammamet"}}},"160":{"name":"Zaghouan","shp":"zaghouane","delegations":{"51":{"name":"Zaghouan"},"52":{"name":"Zriba"},"53":{"name":"Bir Mchergua"},"54":{"name":"Fahs"},"55":{"name":"Nadhour"},"56":{"name":"Saouaf"}}},"170":{"name":"Bizerte","shp":"bizerte","delegations":{"51":{"name":"Bizerte Nord"},"53":{"name":"Bizerte Sud"},"54":{"name":"Sejnane"},"55":{"name":"Joumine"},"56":{"name":"Mateur"},"57":{"name":"Ghazala"},"58":{"name":"Menzel Bourguiba"},"59":{"name":"Tinja"},"60":{"name":"Utique"},"61":{"name":"Ghar El Melh"},"62":{"name":"Menzel Jemil"},"63":{"name":"El Alia"},"64":{"name":"Ras Jebel"}}},"210":{"name":"Beja","shp":"beja","delegations":{"51":{"name":"Béja Nord"},"52":{"name":"Béja Sud"},"53":{"name":"Amdoun"},"54":{"name":"Nefza"},"55":{"name":"Téboursouk"},"56":{"name":"Thibar"},"57":{"name":"Testour"},"58":{"name":"Goubellat"},"59":{"name":"Mejez El Bab"}}},"220":{"name":"Jendouba","shp":"jendouba","delegations":{"51":{"name":"Jendouba Sud"},"52":{"name":"Jendouba Nord"},"53":{"name":"Bousalem"},"54":{"name":"Tabarka"},"55":{"name":"Aïn Draham"},"56":{"name":"Fernana"},"57":{"name":"Ghardimaou"},"58":{"name":"Oued Mliz"},"59":{"name":"Balta Bou Aouane"}}},"230":{"name":"Le Kef","shp":"lekef","delegations":{"51":{"name":"Kef Ouest"},"52":{"name":"Kef Est"},"53":{"name":"Nebeur"},"54":{"name":"Sakiet Sidi Youssef"},"55":{"name":"Tajerouine"},"56":{"name":"Kalaat Senan"},"57":{"name":"Kalaa Khesba"},"58":{"name":"Jerissa"},"59":{"name":"Ksour"},"60":{"name":"Dahmani"},"61":{"name":"Es Sers"}}},"240":{"name":"Siliana","shp":"siliana","delegations":{"51":{"name":"Siliana Nord"},"52":{"name":"Siliana Sud"},"53":{"name":"Bouarada"},"54":{"name":"Gaafour"},"55":{"name":"El Krib"},"56":{"name":"Bourouis"},"57":{"name":"Makthar"},"58":{"name":"Rouhia"},"59":{"name":"Kesra"},"60":{"name":"Bargou"},"61":{"name":"Laroussa"}}},"310":{"name":"Sousse","shp":"sousse","delegations":{"51":{"name":"Sousse Médina"},"52":{"name":"Sousse Riadh"},"53":{"name":"Sousse Jaouhara"},"54":{"name":"Sousse Sidi Abdelhamid"},"55":{"name":"Hammam Sousse"},"56":{"name":"Akouda"},"57":{"name":"Kalaa Kebira"},"58":{"name":"Sidi Bou Ali"},"59":{"name":"Hergla"},"60":{"name":"Enfidha"},"61":{"name":"Bouficha"},"62":{"name":"Kondar"},"63":{"name":"Sidi El Heni"},"64":{"name":"M'Saken"},"65":{"name":"Kalaa Sghira"},"66":{"name":"Zaouia Ksiba Thraya"}}},"320":{"name":"Monastir","shp":"monastir","delegations":{"51":{"name":"Monastir"},"52":{"name":"Ouerdanine"},"53":{"name":"Sahline"},"54":{"name":"Zeramdine"},"55":{"name":"Beni Hassen"},"56":{"name":"Jammel"},"57":{"name":"Bembla"},"58":{"name":"Moknine"},"59":{"name":"Bekalta"},"60":{"name":"Teboulba"},"61":{"name":"Ksar Hellal"},"62":{"name":"Ksibet El Mediouni"},"63":{"name":"Sayada-Lamta-Bou Hjar"}}},"330":{"name":"Mahdia","shp":"mahdia","delegations":{"51":{"name":"Mahdia"},"52":{"name":"Boumerdès"},"53":{"name":"Ouled Chamekh"},"54":{"name":"Chorbane"},"55":{"name":"Hbira"},"56":{"name":"Souassi"},"57":{"name":"El Jem"},"58":{"name":"Chebba"},"59":{"name":"Melloulech"},"60":{"name":"Sidi Alouane"},"61":{"name":"Ksour Essef"}}},"341":{"name":"Sfax 1","shp":"sfax1","delegations":{"53":{"name":"Sakiet Ezzit"},"54":{"name":"Sakiet Eddaier"},"58":{"name":"Jebeniana"},"59":{"name":"El Amra"},"60":{"name":"Hencha"},"61":{"name":"Menzel Chaker"},"63":{"name":"Bir Ali Ben Khélifa"},"66":{"name":"Kerkennah"}}},"342":{"name":"Sfax 2","shp":"sfax2","delegations":{"51":{"name":"Sfax Médina"},"52":{"name":"Sfax Ouest"},"55":{"name":"Sfax Sud"},"57":{"name":"Agareb"},"62":{"name":"El Ghraiba"},"64":{"name":"Skhira"},"65":{"name":"Mahres"}}},"410":{"name":"Kairouan","shp":"kairouan","delegations":{"51":{"name":"Kairouan Nord"},"52":{"name":"Kairouan Sud"},"53":{"name":"Chebika"},"54":{"name":"Sbikha"},"55":{"name":"Oueslatia"},"56":{"name":"Haffouz"},"57":{"name":"Alaa"},"58":{"name":"Hajeb El Ayoun"},"59":{"name":"Nasrallah"},"60":{"name":"Chrarda"},"61":{"name":"Bouhajla"}}},"420":{"name":"Kasserine","shp":"kasserine","delegations":{"51":{"name":"Kasserine Nord"},"52":{"name":"Kasserine Sud"},"53":{"name":"Ezzouhour"},"54":{"name":"Hassi El Ferid"},"55":{"name":"Sbeitla"},"56":{"name":"Sbiba"},"57":{"name":"Jedeliane"},"58":{"name":"Ayoun"},"59":{"name":"Thala"},"60":{"name":"Hidra"},"61":{"name":"Foussana"},"62":{"name":"Feriana"},"63":{"name":"Majel Belabbes"}}},"430":{"name":"Sidi Bou Zid","shp":"sidibouzid","delegations":{"51":{"name":"Sidi Bouzid Ouest"},"52":{"name":"Sidi Bouzid Est"},"53":{"name":"Jelma"},"54":{"name":"Sabalat Ouled Asker"},"55":{"name":"Bir El Hfay"},"56":{"name":"Sidi Ali Ben Aoun"},"57":{"name":"Menzel Bouzaiene"},"58":{"name":"Meknassi"},"59":{"name":"Souk Jedid"},"60":{"name":"Mazzouna"},"61":{"name":"Regueb"},"62":{"name":"Ouled Haffouz"}}},"510":{"name":"Gabes","shp":"gabes","delegations":{"51":{"name":"Gabès Médina"},"52":{"name":"Gabès Ouest"},"53":{"name":"Gabès Sud"},"54":{"name":"Ghannouch"},"55":{"name":"Metouia"},"56":{"name":"Menzel Habib"},"57":{"name":"Hamma"},"58":{"name":"Matmata"},"59":{"name":"Matmata Nouvelle"},"60":{"name":"Mareth"}}},"520":{"name":"Medenine","shp":"medenine","delegations":{"51":{"name":"Médenine Nord"},"52":{"name":"Médenine Sud"},"53":{"name":"Beni Khedache"},"54":{"name":"Ben Guerdane"},"55":{"name":"Zarzis"},"56":{"name":"Houmt Souk"},"57":{"name":"Djerba Midoun"},"58":{"name":"Djerba Ajim"},"59":{"name":"Sidi Makhlouf"}}},"530":{"name":"Tataouine","shp":"tataouine","delegations":{"51":{"name":"Tataouine Nord"},"52":{"name":"Tataouine Sud"},"53":{"name":"Samar"},"54":{"name":"Bir Lahmar"},"55":{"name":"Ghomrassen"},"56":{"name":"Dhiba"},"57":{"name":"Remada"}}},"610":{"name":"Gafsa","shp":"gafsa","delegations":{"51":{"name":"Gafsa Nord"},"52":{"name":"Sidi Aich"},"53":{"name":"Ksar"},"54":{"name":"Gafsa Sud"},"55":{"name":"Oum Larais"},"56":{"name":"Redeyef"},"57":{"name":"Metlaoui"},"58":{"name":"Mdhilla"},"59":{"name":"Guetar"},"60":{"name":"Belkhir"},"61":{"name":"Sened"}}},"620":{"name":"Tozeur","shp":"tozeur","delegations":{"51":{"name":"Tozeur"},"52":{"name":"Degueche"},"53":{"name":"Tamaghza"},"54":{"name":"Nefta"},"55":{"name":"Hazoua"}}},"630":{"name":"Kebili","shp":"kebili","delegations":{"51":{"name":"Kebili Sud"},"52":{"name":"Kebili Nord"},"53":{"name":"Souk El Ahed"},"54":{"name":"Douz Nord"},"55":{"name":"Douz Sud"},"56":{"name":"Faouar"}}}};
...
var displayedMap,
    ...
    globalPath,
    circonscriptionMap, 
    circonscriptionResults,
    circonscriptionPath,
    selectedParty,
    selectedCirconscription,
    representativesPerCirconscription,
    representativesPerParty,
    resultsPerParty,
...
d3.json('data/flat/representativesPerCirconscription.json',function(json){representativesPerCirconscription = json;});
d3.json('data/flat/resultsPerParty.json',function(json){resultsPerParty = json;});
...
function load(svg, width, height) {
	...
	data = json;
		...
		data.repByParty = d3.nest().key(function(d) {return d.id}).key(function(d) {return d.id}).map(data.elus);
		updateInfoBox();
	    });    
	});
...
function updatePartyBar(){
     var table = d3.select("#partyBar");
    if (selectedParty){
	var i = data.elus.map(function(d){return d.id}).indexOf(selectedParty);
	var barData  = [(selectedCirconscription ? representativesPerCirconscription[selectedCirconscription][selectedParty] : data.elus[i])];
	barData[0].id = selectedParty;//FIXME work around : nromalize global/percirco data
	table.select('tbody')
	    .select('tr').remove();
...
function updateInfoBox() {   
    ...
    if (selectedParty){
	if (selectedCirconscription){
	    infoData = d3.entries( CIRCONSCRIPTIONS[selectedCirconscription].delegations)
		.map(function(_){
		    var r = resultsPerCirconscriptionPerParty[selectedCirconscription][selectedParty];   
		    return {name:_.value.name,pourcentage:r[_.key].pourcentage, vote:r[_.key].vote, id : 'c'+ selectedCirconscription +'d' +_.key};
		})
	} else {
	    infoData = d3.entries(resultsPerParty[selectedParty]);
	...
	tr.enter()
	    ...
	    .style('cursor', selectedCirconscription ? null : 'pointer');
	
	tr.append("td")
	    .text(function(_){
		return selectedCirconscription ? _.name : CIRCONSCRIPTIONS[_.key].name;
	    });
	tr.append('td')
	    .text(function(_){return Math.floor( (selectedCirconscription ?_.pourcentage : _.value.pourcentage) * 100) / 100 +"%"; } )
	    .classed("percentageBig",true);
	
	tr.append("td")
	    .text(function(_){
		return formatNumber(selectedCirconscription ?_.vote : _.value.vote);
	    });
	if(!selectedCirconscription){
	    tr.append("td")
		.filter(function(_){return representativesPerCirconscription[_.key][_.value.id];})
		.append('span')
		.text(function(_){
		    if (representativesPerCirconscription[_.key][_.value.id]) return representativesPerCirconscription[_.key][_.value.id].elus.length;
	...
	if (selectedCirconscription){
	    infoData = d3.entries(representativesPerCirconscription[selectedCirconscription]).map(function(_){var r = {}; r = _.value; r.id = _.key;r.pourcentage = r.percent; return r}).sort(function(a,b){return a.vote < b.vote});
	}else{
	    infoData = data.elus;
	}
...
function createPartyLine(tr){
    ...
    partyLink.html(function(_){
    	...
    	var txt = PARTIES[_.id] ? PARTIES[_.id]['name-en'] :_.name;
    	return img+txt;
   })
   	
    party.on('click',function(_){selectedParty ? selectParty() : selectParty(_.id);})
	.on('dblclick',function(_){selectedParty ? selectParty() : selectParty(_.id);});
...
function mouseover2(d,i){
    ...
    if (selectedCirconscription){
	tooltipData = delegationModeActive(d) && d.properties.code_circo == selectedCirconscription ? d.properties.agg.resultat.listes.filter(function(d,i){return i < 5;}) : [];
    } else {
	tooltipData = d.properties.elus.listes;
    }
    if (selectedParty){ 
	var partyResult = getPartyResult(d,selectedParty);
	if (!selectedCirconscription) partyResult.elus = representativesPerCirconscription[d.properties.code_circo][selectedParty].elus;
	tooltipData = [partyResult];//representativesPerCirconscription[_.key][_.value.id].elus.length
    }
...
function selectCirconscription(id){
	...
	d3.json('data/geojson/'+CIRCONSCRIPTIONS[selectedCirconscription].shp+'.json',function(circoGeojson){
	    ...
	    d3.json('data/flat/circonscriptions/' + selectedCirconscription +'.json',function(flatResults){
		resultsPerCirconscriptionPerParty[selectedCirconscription] = flatResults;
