...
function mouseover2(d,i){
    ...
    var tooltipData = selectedCirconscription && (typeof d.properties.agg !== "undefined") ? d.properties.agg.resultat.listes.filter(function(d,i){return i < 5;}) : d.properties.elus.listes;
    if (selectedCirconscription){
	tooltipData = (d.properties.code_deleg && (typeof d.properties.agg !== "undefined")) ? d.properties.agg.resultat.listes.filter(function(d,i){return i < 5;}) : [];
    } else {
