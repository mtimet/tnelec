...
function updateInfoBox() {
	...
	if (selectedCirconscription){
	    infoData = d3.entries(representativesPerCirconscription['111']).map(function(_){var r = {}; r = _.value; r.id = _.key;r.pourcentage = r.percent; return r}).sort(function(a,b){return a.vote < b.vote});
	}else{
	    infoData = data.elus;
	}
