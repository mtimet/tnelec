...
function updateInfoBox() {
	...
	tr.append("td")
	    .text(function(_){
		return CIRCONSCRIPTIONS[_.key].name;
	    });
	tr.append('td')
	    .text(function(_){return Math.floor(_.value.pourcentage * 100) / 100 +"%"; } )
	    .classed("percentageBig",true);
	
	tr.append("td")
	    .text(function(_){
		return formatNumber(_.value.vote);
	    });
